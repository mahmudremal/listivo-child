    ...
    <div class="listivo-menu-v2-wrapper">
        ...
        >
            ...
            <div class="listivo-menu-v2__container">
                 ...
                 * Added by child theme to include category nav menu items.

                 */

                get_template_part( 'templates/nav/header', 'searchbar' ); ?>
                                ...
                                <div class="listivo-menu-v2__user-menu">
                                    ...
                                    <div class="listivo-user-dropdown">
                                        ...
                                        <div class="listivo-user-dropdown__list">
                                            ...
                                            <?php endif; ?>
                                            <?php if (class_exists(\WooCommerce::class) && tdf_settings()->paymentsEnabled()) : ?>
            ...
            get_template_part( 'templates/nav/header', 'category' ); ?>
...
document.onload = function() {
    var text, id, par, node, form, elem = document.querySelectorAll('.searchbarLiquid .fields .category');
    form = document.querySelector('#fwp-listivo-nav-search');
    elem.forEach(function (el, ei) {
        text = el.querySelector('.touch-box input[type="text"]');
        id = el.querySelector('.touch-box input[type="hidden"]');
        node = document.querySelectorAll('.options ul li a');
        node.forEach(function (nl, ni) {
        nl.addEventListener('click', function (ne) {
            // text.value = ( this.dataset.title ) ? this.dataset.title : text.dataset.all;
            // id.value = ( this.dataset.id ) ? this.dataset.id : 0;
            
            // if (form ) {
            //     form.action = ( this.dataset.href ) ? this.dataset.href : form.dataset.action;
            // }
            if( ne.querySelector( '[class^=icon-]' ) ) {
                text.previousElementSibling.classList.value = ne.querySelector( '[class^=icon-]' ).classList.value;
            } else {
                console.log( 'III' )
            }
